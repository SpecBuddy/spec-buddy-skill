...
**Skills** — from the skills available in the current session, select those relevant to the plan's domain. Add domain-specific skills where applicable.
